...
impl BotKind {
    ...
    pub fn meta(&self) -> BotKindMeta {
        match self {
            Self::Broadcast => BotKindMeta {
                label: "Broadcast",
                icon: "📢",
            },
            Self::Gatekeeper => BotKindMeta {
                label: "Gatekeeper",
                icon: "🔒",
            },
            Self::Monitor => BotKindMeta {
                label: "Monitor",
                icon: "📊",
            },
            Self::Digest => BotKindMeta {
                label: "Digest",
                icon: "📋",
            },
            Self::UserBot => BotKindMeta {
...
impl Platform {
    ...
    pub fn meta(&self) -> PlatformMeta {
        match self {
            Self::Telegram => PlatformMeta {
                label: "Telegram",
                icon: "✈",
            },
            Self::Matrix => PlatformMeta {
                label: "Matrix",
                icon: "🔷",
            },
            Self::Discord => PlatformMeta {
                label: "Discord",
                icon: "🎮",
            },
            Self::RocketChat => PlatformMeta {
                label: "Rocket.Chat",
                icon: "🚀",
            },
            Self::Mattermost => PlatformMeta {
                label: "Mattermost",
                icon: "📡",
            },
            Self::Slack => PlatformMeta {
                label: "Slack",
                icon: "💼",
            },
            Self::XMPP => PlatformMeta {
                label: "XMPP",
                icon: "💬",
            },
        }
    ...
    pub fn credential_fields(&self) -> Vec<CredentialField> {
        match self {
            ...
            Self::Discord => vec![CredentialField {
                name: "Bot Token",
                placeholder: "MTx....",
                is_secret: true,
            }],
...
impl MessagingBot {
    ...
    pub fn demo_bots() -> Vec<Self> {
        let mut broadcast =
            MessagingBotBuilder::new("broadcast", "Broadcast Bot", BotKind::Broadcast)
                .enabled()
                .target("Telegram", "FreeSynergy Community", "-100123")
                .target("Matrix", "#general:example.com", "!abc:example.com")
                .build();
        broadcast.recent_broadcasts = vec![BroadcastRecord {
        ...
        let mut gatekeeper =
            MessagingBotBuilder::new("gatekeeper", "Gatekeeper Bot", BotKind::Gatekeeper)
                .enabled()
                .target("Telegram", "FreeSynergy Community", "-100123")
                .build();
